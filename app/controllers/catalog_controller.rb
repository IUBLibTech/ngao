...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    ##### REMOVE BOOKMARK AND HISTORY FROM NAVBAR #####
    ...
    config.add_facet_field 'date_range_sim', label: 'Year', range: {assumed_boundaries: [0, Time.now.year + 2]}, :include_in_advanced_search => false
